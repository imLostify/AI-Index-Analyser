...
class LLMClient:
    ...
    def generate_comprehensive_report(self, full_analysis: Dict, max_tokens: int = None) -> str:
        """
        ...
        try:
            ...
            # Erstelle strukturierten Prompt für das LLM
            prompt = f"""
            ...
            messages = [
                {"role": "system", "content": "Du bist ein professioneller Finanzanalyst. Erstelle konsistente, datenbasierte Berichte ohne Widersprüche. Verwende IMMER die bereitgestellten Daten."},
            ...
            report = self._add_report_metadata(report, ticker, current_price, market_direction)
    ...
    def _add_report_metadata(self, report: str, ticker: str, price: float, market_direction: Dict) -> str:
        """
...
"""
    ...
    def _generate_consistent_report(self, data: Dict) -> str:
        ...
        market_direction = self._determine_market_direction(indicators, probabilities)
...
"""
    ...
    def _determine_market_direction(self, indicators: Dict, probabilities: Dict) -> Dict:
...
"""
    ...
    def analyze_indicators(self, indicators: Dict, data_summary: Dict, max_tokens: int = None) -> str:
        ...
        try:
            ...
            messages = [
                {"role": "system", "content": "Du bist ein technischer Analyst. Verwende IMMER die exakten Werte aus den Daten."},
                {"role": "user", "content": prompt}
            ]
    ...
    def analyze_probabilities(self, probabilities: Dict, targets: Dict, sentiment: str, max_tokens: int = None) -> str:
        ...
        try:
            ...
            messages = [
                {"role": "system", "content": "Du bist ein Risikoanalyst. Basiere deine Empfehlungen auf den gegebenen Wahrscheinlichkeiten."},
                {"role": "user", "content": prompt}
            ]
    ...
    def analyze_fibonacci_support_resistance(self, fibonacci_levels: Dict, support_resistance: Dict, max_tokens: int = None) -> str:
        ...
        try:
            ...
            messages = [
                {"role": "system", "content": "Du bist ein technischer Analyst spezialisiert auf Fibonacci und Support/Resistance. Verwende IMMER die exakten Level aus den Daten."},
                {"role": "user", "content": prompt}
            ]
    ...
    def generate_market_report(self, full_analysis: Dict, max_tokens: int = None) -> str:
        """Wrapper für Kompatibilität"""
        return self.generate_comprehensive_report(full_analysis, max_tokens)
    
    def generate_complete_report(self, full_analysis: Dict, max_tokens: int = None) -> str:
        """Wrapper für Kompatibilität"""
        return self.generate_comprehensive_report(full_analysis, max_tokens)
    
    def answer_question(self, question: str, context: Dict, max_tokens: int = None) -> str:
        ...
        try:
            ...
            messages = [
                {"role": "system", "content": "Du bist ein hilfreicher Trading-Assistent. Beantworte Fragen basierend auf den technischen Daten."},
                {"role": "user", "content": prompt}
            ]
